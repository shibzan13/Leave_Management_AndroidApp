    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginredirectbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(getApplicationContext(),flogin.class);
        ...
        signupButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!PASSWORD_PATTERN.matcher(pass).matches()) {
                    Toast.makeText(fregister.this, "Password should be alphanumeric", Toast.LENGTH_SHORT).show();
                }
                        ...
                        .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    Intent intent=new Intent(getApplicationContext(),Fhomescreen.class);
                                    startActivity(intent);
                                    ...
                                    Toast.makeText(fregister.this, "Authentication failed.",
        ...
        loginRedirectText.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(fregister.this,flogin.class));
            }
        });
