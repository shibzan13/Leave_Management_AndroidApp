...
public class upload extends AppCompatActivity {
    ...
    Button saveButton;
    EditText uploadDesc,uploadName;
    String imageURL;
    Uri uri;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        uploadName=findViewById(R.id.inputname);
        uploadImage = findViewById(R.id.uploadImage);
        uploadDesc = findViewById(R.id.rtex);
        saveButton = findViewById(R.id.pb);
    ...
    public void uploadData() {
        ...
        FirebaseDatabase.getInstance().getReferenceFromUrl("https://myapp-e3efe-default-rtdb.firebaseio.com//UPLOADED MEDICAL CERTIFICATES")
                .child(uploadName.getText().toString()) // Use uploadName.getText().toString() instead of name
                .setValue(dataClass)
