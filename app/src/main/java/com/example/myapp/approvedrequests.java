...
public class approvedrequests extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_approvedrequests);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReferenceFromUrl("https://myapp-e3efe-default-rtdb.firebaseio.com///APPROVE");
